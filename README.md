...
| DB | PostgreSQL 17 연동, Flyway V1~V5(12개 중 9개 테이블) 구현 |
...
| 요청 API | 공개 대타·교대, 복수 교대 가능일, 사장 급구, 상세 조회·취소·중복 방지 구현 |
...
- 지원·지정 제안과 교대 후보 근무 API 구현
- 사장·점장 승인 후 실제 근무 담당자 변경·교대 처리
- 요청·지원·승인 상태별 알림 구현
